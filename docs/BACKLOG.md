...
| ICO-001 | Allergen-Symbole und Herkunftsflaggen in Admin, Web, Signage und PDF | Erudus für 14 Allergengruppen, flag-icons für Länder als recherchierte Auswahl; lokale, gepinnte SVGs, Lizenzen und gemeinsame Code-Zuordnung. Erkennbarkeit im Druck, in responsiven Browseransichten und auf Yodeck noch prüfen. |
...
| QA-001 | Generische responsive und Yodeck-Abnahme | Nutzerkorrektur: generisch statt bestimmtem Samsung-Modell. Tablet/Telefon/Desktop nach CSS-Breiten; Signage mit Yodeck auf Raspberry Pi 4B, FHD als gemeinsames Ziel und 4K bei passender Hardware. Lesbarkeit, Hoch-/Querformat, Refresh und Fallback prüfen; Browsernachweis und tatsächliche Playerabnahme auseinanderhalten. |
...
**Lieferfolge:** UI-001/UI-002 sind ausgeliefert. Komponentenfilter und globale Darstellung laufen bei Codex; API-001 bearbeitet Claude parallel. Screens-/Vorlagen-Navigation, Symbolbasis, Branding, Bereiche/Zeiten, Benutzer/Entra sowie Rezept-/Lager-/Kalkulationsfunktionen folgen dem verlinkten Ausführungsplan in getrennten geprüften Paketen. Schemaänderungen mit Claudes reservierter API-Migration 16→17 und gemeinsame Deploys abstimmen.
