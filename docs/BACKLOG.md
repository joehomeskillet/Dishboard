...
Die frühere Branding-Browserprüfung mit 798 Checks/40 Screenshots blieb wegen 21 Befunden FAIL. Die Diagnose belegte 19 Geometrie-Fehlalarme bei vollständig sichtbarem Text; die echte mobile HTML-Druckkartenabweichung ist mit dieser Lieferung behoben. Der frühere Logo-MIME-Befund war ein Operator-Fehlalarm: öffentliches PNG jeweils HTTP 200 mit `image/png` vor und nach 304 zweimal bestätigt. **Ein vollständig grüner Branding-Gesamtnachweis liegt weiterhin nicht vor.** Fachliche Küchenbestätigung, physischer Yodeck-Player und externer Design-Validator bleiben separate Abnahmen.
...
Der vorbereitete Fallback gilt ausschliesslich für einen nachgewiesenen UI-Fehler nach erfolgreicher Schema-19-Migration; Schema-/Kernfehler benötigen einen eigenen Rückweg.
