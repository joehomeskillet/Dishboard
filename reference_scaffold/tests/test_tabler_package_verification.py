...
@pytest.mark.parametrize(
    'migration_name',
    ['0015_v17_to_v18.sql', '0016_v18_to_v19.sql', '0017_v19_to_v20.sql', '0018_v20_to_v21.sql', '0019_v21_to_v22.sql', '0020_v22_to_v23.sql'],
)
...
def test_package_requires_branding_schema_and_pinned_migration(monkeypatch, capsys, fault, migration_name):
    ...
    output = capsys.readouterr().out
    errors = {
        'schema17': '[FEHLER] Schema-Version ist nicht 23.',
        'schema18': '[FEHLER] Schema-Version ist nicht 23.',
