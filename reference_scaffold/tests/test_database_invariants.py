...
def test_migration_plan_is_ordered_and_preserves_0001_bytes() -> None:
    ...
    assert [(migration.version, migration.path.name) for migration in plan] == [
        ...
        (27, '0024_v26_to_v27.sql'),
        (28, '0025_v27_to_v28.sql'),
        (29, '0026_v28_to_v29.sql'),
        (30, '0027_v29_to_v30.sql'),
        (31, '0028_v30_to_v31.sql'),
        (32, '0029_v31_to_v32.sql'),
        (33, '0030_v32_to_v33.sql'),
        (34, '0031_v33_to_v34.sql'),
        (35, '0032_v34_to_v35.sql'),
        (36, '0033_v35_to_v36.sql'),
        (37, '0034_v36_to_v37.sql'),
        (38, '0035_v37_to_v38.sql'),
        (39, '0036_v38_to_v39.sql'),
        (40, '0037_v39_to_v40.sql'),
        (41, '0038_v40_to_v41.sql'),
        (42, '0039_v41_to_v42.sql'),
        (43, '0040_v42_to_v43.sql'),
    ]
...
def test_empty_database_runs_0001_then_0002(database_engine: Engine) -> None:
    ...
    assert [row.version for row in rows] == list(range(4, 44))
...
def test_v4_fixture_migrates_without_replaying_0001() -> None:
    ...
    assert versions == list(range(4, 44))
    _drop_schema(engine)
    engine.dispose()
...
def test_app_grants_are_column_scoped_and_owner_issuance_still_works(
    ...
    master_commands = {
        'create_food_category_v21', 'update_food_category_v21', 'set_active_food_category_v21',
        'create_tag_v21', 'update_tag_v21', 'set_active_tag_v21',
        'create_storage_location_v21', 'update_storage_location_v21', 'set_active_storage_location_v21',
        'create_unit_v21', 'rename_unit_v21', 'set_active_unit_v21',
        'create_food_v27', 'update_food_v27', 'update_food_v21', 'set_food_active_v21',
        ...
        'create_recipe_v22', 'update_recipe_v22', 'set_recipe_active_v22', 'freeze_recipe_v27', 'recipe_dependency_preview_v27',
    ...
    assert {row['proname'] for row in definer_privileges} == master_commands | {
        ...
        'validate_local_roles_v19',
        'local_user_command_context_v19',
        'create_local_user_v19',
        'replace_local_roles_v19',
        'reset_local_password_v19',
        'set_local_status_v19',
        'deactivate_local_user_v19',
    ...
    for row in definer_privileges:
        ...
        assert row['app_execute'] is (
            row['proname'] in master_commands | {
                'activate_screen_assignment_v23',
                'lock_operations_actor',
                'lock_component_metadata_masters',
                'lock_active_publication',
