...
def test_v13_real_postgres_contract_covers_catalog_constraints_and_component_links(
    ...
    assert database.SCHEMA_VERSION == version == 18
    assert database.APPLICATION_VERSION == 'dishboard-schema-v18'
    assert (plan[-1].version, plan[-1].path.name) == (18, '0015_v17_to_v18.sql')
