...
def test_v13_real_postgres_contract_covers_catalog_constraints_and_component_links(
    ...
    assert database.SCHEMA_VERSION == version == 19
    assert database.APPLICATION_VERSION == 'dishboard-schema-v19'
    assert (plan[-1].version, plan[-1].path.name) == (19, '0016_v18_to_v19.sql')
