...
def test_v13_real_postgres_contract_covers_catalog_constraints_and_component_links(
    ...
    assert database.SCHEMA_VERSION == version == 17
    assert database.APPLICATION_VERSION == 'dishboard-schema-v17'
    assert (plan[-1].version, plan[-1].path.name) == (17, '0014_v16_to_v17.sql')
