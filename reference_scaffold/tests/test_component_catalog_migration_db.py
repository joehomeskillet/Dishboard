...
def test_v13_real_postgres_contract_covers_catalog_constraints_and_component_links(
    ...
    assert database.SCHEMA_VERSION == version == 29
    assert database.APPLICATION_VERSION == 'dishboard-schema-v29'
    assert (plan[-1].version, plan[-1].path.name) == (29, '0026_v28_to_v29.sql')
