...
def test_v13_real_postgres_contract_covers_catalog_constraints_and_component_links(
    ...
    assert database.SCHEMA_VERSION == version == 41
    assert database.APPLICATION_VERSION == 'dishboard-schema-v41'
    assert (plan[-1].version, plan[-1].path.name) == (41, '0038_v40_to_v41.sql')
