...
REQUIRED_FILES = (
    ...
    'database/migrations/0032_v34_to_v35.sql',
    'database/migrations/0033_v35_to_v36.sql',
    ...
    'database/migrations/0039_v41_to_v42.sql',
    'database/migrations/0040_v42_to_v43.sql',
...
MIGRATION_CHECKSUMS = {
    ...
    '0032_v34_to_v35.sql': '6eeec799dad37cb60bc54cdaf691c5abd0c451244e4b4931fe34ea3ee359ca41',
    '0033_v35_to_v36.sql': 'bc01eb651cd0b69e8e6b2651c3737367acc7c96c6991c7043620db4d7d2f0471',
    ...
    '0039_v41_to_v42.sql': '938d3a6326e7c9dd674ff2d6d89e73cb6615a2c633a1c2ab14c94c50b54a4290',
    '0040_v42_to_v43.sql': '0f07e4d885214532dc039f5032bc3f3107fe15b14dc8f1e7bd810a4979f9b15d',
}
...
def main() -> int:
    ...
    migration_files.append('0032_v34_to_v35.sql')
    migration_files.append('0033_v35_to_v36.sql')
    ...
    migration_files.append('0039_v41_to_v42.sql')
    migration_files.append('0040_v42_to_v43.sql')
    ...
    contract_functions = ('validate_menu_service', 'validate_menu_item_price', 'validate_publication_revision',
                         ...
                         'workflow_week_context', 'record_menu_review', 'record_week_context_review')
