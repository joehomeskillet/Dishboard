...
This project is indexed by GitNexus as **menuplan** (12946 symbols, 25095 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/menuplan/context` | Codebase overview, check index freshness |
| `gitnexus://repo/menuplan/clusters` | All functional areas |
| `gitnexus://repo/menuplan/processes` | All execution flows |
| `gitnexus://repo/menuplan/process/{name}` | Step-by-step execution trace |
...
Berechtigungen, Gates und Übergabe sind für Codex, Claude Code und Grok-Build identisch.
